...
urlpatterns = [
    ...
    path('dish/',list_of_dishes, name='list_of_dishes'),
    path('dish/add', DishAddView. as_view(), name= 'dishes_add'),
    path('dish/delete/<int:pk>/', DishDeleteView. as_view(), name='dishes_delete'),
